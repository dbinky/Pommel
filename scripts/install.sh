...
print_usage() {
    ...
    echo "    3. pm start"
    echo ""
    echo -e "  ${CYAN}Use 'pm status' to monitor indexing progress - but you can"
    echo -e "  use Pommel with a partial index, too.${NC}"
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    echo "  Search your code:          pm search \"your query\""
    echo ""
    echo "  For AI agents:             pm search \"query\" --json"
    echo ""
    echo "  Change provider later:     pm config provider"
    echo ""
